...
namespace laya
{
    ...
    JCNode2D::JCNode2D(int nID,JCResManager* pTextureManager, JCImageManager* pImageManager, JC2DShaderManager* p2DShaderManager,
        ...
        JCBufferManager* pBufferManager, JCShaderManager* pShaderManager, std::vector<JCICmdDispatch*>* vVectorCmdDispath, JCShapedTextCache* pShapedTextCache)
        ...
        case laya::CANVAS_TYPE_RENDER_TARGET:
            {
                ...
                if (m_pCacheCanvas == NULL )
                {
                    ...
                    m_pCacheCanvas = new JCHtml5Render(nID, m_pTextureManager, m_pImageManager, m_p2DShaderManager, m_pHtml5RenderManager, m_pTextManager, m_pFontManager, m_pBufferManager, m_pShaderManager, m_vVectorCmdDispath, m_pShapedTextCache);
