...
public:
    ...
    */
    OpenALSourceInfo* playWav(JCAudioInterface* p_pAudio, const std::string& p_sUrl);
	...
	*/
	...
	bool AddWaveInfo( const std::string& p_sUrl,JCBuffer& p_pBuffer,int p_nSize,void* p_pExternalMark,bool p_bIsOgg );
