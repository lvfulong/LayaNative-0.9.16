...
namespace laya
{
    JCGraphicsCmdDispath::JCGraphicsCmdDispath(int nID,JCResManager* pTextureManager, JCImageManager* pImageManager, JC2DShaderManager* p2DShaderManager,
        ...
        JCBufferManager* pBufferManager, JCShaderManager* pShaderManager,TEXT_BASE_LINE_TYPE nBaseLineType, JCShapedTextCache* pShapedTextCache)
    {
        m_pGraphics = new JCGraphics(nID,pTextureManager, pImageManager, p2DShaderManager, pHtml5RenderManager, 
                                    pTextManager,pFontManager, pBufferManager, pShaderManager, nBaseLineType, pShapedTextCache);
    ...
    bool JCGraphicsCmdDispath::runRenderCmd(JCMemClass& pRenderCmd)
    {
        static const ProcFunction g_svProcFunctions[] =
        {
            ...
            &JCGraphicsCmdDispath::_rendercmd_direction,
            &JCGraphicsCmdDispath::_rendercmd_drawPrimitive,
        };
    ...
    bool JCGraphicsCmdDispath::saveRenderCmd(JCMemClass& pRenderCmd)
    {
        static const ProcFunction g_svSaveProcFunctions[] =
        {
            ...
            &JCGraphicsCmdDispath::_savecmd_direction,
            &JCGraphicsCmdDispath::_savecmd_drawPrimitive,
        };
    ...
    bool JCGraphicsCmdDispath::calcBoundingBox(JCMemClass& pRenderCmd, std::vector<Matrix32>& vMatrixs, Matrix32& kCurrentMatrix, std::vector<float>& vResultPointArray)
    {
        static const CalcBoundingBoxFunction g_svCalcBoundingBoxProcFunctions[] =
        {
            ...
            &JCGraphicsCmdDispath::_calcBoundingBox_direction,
            &JCGraphicsCmdDispath::_calcBoundingBox_drawPrimitive,
        };
    ...
    void JCGraphicsCmdDispath::_rendercmd_drawImage(JCMemClass& cmdBuffer)
    {
        ...
        m_pGraphics->drawImage(cmdDrawImage9Alpha->imgID, cmdDrawImage9Alpha->sx, cmdDrawImage9Alpha->sy, cmdDrawImage9Alpha->sw, cmdDrawImage9Alpha->sh, cmdDrawImage9Alpha->dx, cmdDrawImage9Alpha->dy, cmdDrawImage9Alpha->dw, cmdDrawImage9Alpha->dh, cmdDrawImage9Alpha->alpha,cmdDrawImage9Alpha->nType, cmdDrawImage9Alpha->blendMode);
    }
    void JCGraphicsCmdDispath::_rendercmd_drawImageM(JCMemClass& cmdBuffer)
    {
        ...
        m_pGraphics->drawImageM(cmdDrawImageM->imgID, cmdDrawImageM->sx, cmdDrawImageM->sy, cmdDrawImageM->sw, cmdDrawImageM->sh, cmdDrawImageM->dx, cmdDrawImageM->dy, cmdDrawImageM->dw, cmdDrawImageM->dh, cmdDrawImageM->a,
            cmdDrawImageM->b, cmdDrawImageM->c, cmdDrawImageM->d, cmdDrawImageM->tx, cmdDrawImageM->ty,cmdDrawImageM->alpha, cmdDrawImageM->nType, cmdDrawImageM->blendMode);
    }
    ...
    void JCGraphicsCmdDispath::_rendercmd_direction(JCMemClass& cmdBuffer)
    {
        CMDInt* cmdInt = cmdBuffer.popp<CMDInt>();
    }
    void JCGraphicsCmdDispath::_rendercmd_drawPrimitive(JCMemClass& cmdBuffer)
    {
        CMDrawPrimitive* cmdDrawPrimitive = cmdBuffer.popp<CMDrawPrimitive>();
        m_pGraphics->drawPrimitive(cmdDrawPrimitive->imgId, cmdDrawPrimitive->type, cmdDrawPrimitive->blendMode, cmdDrawPrimitive->l, cmdDrawPrimitive->t, cmdDrawPrimitive->w, cmdDrawPrimitive->h, cmdDrawPrimitive->x, cmdDrawPrimitive->y, cmdDrawPrimitive->verticesId, cmdDrawPrimitive->uvsId, cmdDrawPrimitive->indicesId, cmdDrawPrimitive->mat, cmdDrawPrimitive->alpha, cmdDrawPrimitive->vertexNum, cmdDrawPrimitive->ibBytes);
    }
    //------------------------------------------------------------------------------
    //------------------------------------------------------------------------------
    //------------------------------------------------------------------------------
    ...
    void JCGraphicsCmdDispath::_savecmd_drawImage(JCMemClass& cmdBuffer)
    {
        ...
        m_pGraphics->setDrawImageFlag(cmdDrawImage9->imgID, cmdDrawImage9->sx, cmdDrawImage9->sy, cmdDrawImage9->sw, cmdDrawImage9->sh, cmdDrawImage9->dx, cmdDrawImage9->dy, cmdDrawImage9->dw, cmdDrawImage9->dh,cmdDrawImage9->alpha,cmdDrawImage9->nType, cmdDrawImage9->blendMode);
        m_pGraphics->repaint();
    }
    ...
    void JCGraphicsCmdDispath::_savecmd_direction(JCMemClass& cmdBuffer)
    {
        CMDInt* cmdInt = cmdBuffer.popp<CMDInt>();
        m_pGraphics->m_pSaveCmd->append(*cmdInt);
        m_pGraphics->direction(cmdInt->i);
        m_pGraphics->repaint();
    }
    void JCGraphicsCmdDispath::_savecmd_drawPrimitive(JCMemClass& cmdBuffer)
    {
        CMDrawPrimitive * cmdDrawPrimitive = cmdBuffer.popp<CMDrawPrimitive>();
        m_pGraphics->m_pSaveCmd->append(*cmdDrawPrimitive);
        m_pGraphics->repaint();
    }
    //------------------------------------------------------------------------------
    //------------------------------------------------------------------------------
    ...
    void JCGraphicsCmdDispath::_calcBoundingBox_direction(JCMemClass& cmdBuffer, std::vector<Matrix32>& vMatrixs, Matrix32& kCurrentMatrix, std::vector<float>& vResultPointArray)
    {
        CMDInt* cmdInt = cmdBuffer.popp<CMDInt>();
    }
    void JCGraphicsCmdDispath::_calcBoundingBox_drawPrimitive(JCMemClass& cmdBuffer, std::vector<Matrix32>& vMatrixs, Matrix32& kCurrentMatrix, std::vector<float>& vResultPointArray)
    {
        CMDrawPrimitive * cmdDrawPrimitive = cmdBuffer.popp<CMDrawPrimitive>();
    }
