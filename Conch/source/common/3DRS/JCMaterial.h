...
namespace laya
{
    ...
    public:
        ...
        void setTexture(int id, const std::shared_ptr<JCDisplayRes>& pDisplayRes);

        void setFillColorShaderParam( float p_nAlpha, int p_nBlendType);

        void setDrawImageShaderParam(const std::shared_ptr<JCDisplayRes>& pDisplayRes, float p_nAlpha, int p_nBlendType);

        

        void setFillImageShaderParam(const std::shared_ptr<JCDisplayRes>& pDisplayRes, float p_nAlpha, int p_nBlendType,float nParam1,float nParam2,float nParam3,float nParam4 );

        void setDrawFilterImageShaderParam(const std::shared_ptr<JCDisplayRes>& pDisplayRes, float p_nAlpha, int p_nBlendType, float p_nFilterR, float p_nFilterG, float p_nFilterB, float p_nFilterGray);

        virtual JCNamedData* getNamedData();

		void setDrawImageShaderParam2(JCTexture* pTexture, float p_nAlpha, int p_nBlendType);
    public:
    ...
    public:
        ...
        //------------------------------------------------------------------------------
        std::shared_ptr<JCDisplayRes>      m_pDisplayRes[2];                     //Texture
        JCTexture*      m_pTexture[2];
