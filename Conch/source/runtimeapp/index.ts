...
interface parseHtmlCB{
    onOpenTag?:(name:string,attribs:Object)=>void;
    onText?:(txt:string)=>void;
    onCloseTag?:(name:string)=>void;
    onComment?:(data:string)=>void;
    onError?:(line:number,pos:number)=>void;
    onEnd?:()=>void;
}

function parseHTML(data:string,cb:parseHtmlCB){
...
/*
function showError(code:number, desc:string){
...
parseHTML('',{
    onOpenTag:(name,attribs)=>{
        if(name=='javascript'){
            ...
            //error;
            showError(100,'not supported tag '+name);
        }
    }
})
*/
