...
namespace laya
{
    ...
    */
    ...
    public:
        ...
        void drawImage(int nImageID, float sx, float sy, float sw, float sh, float dx, float dy, float dw, float dh,float alpha,int nType, int blendMode);
        ...
        */
        void setDrawImageFlag(int nImageID, float sx, float sy, float sw, float sh, float dx, float dy, float dw, float dh,float alpha,int nType, int blendType);
        ...
        */
        ...
        void direction(int nDirection);

        void drawPrimitive(int nImageID, int type, int blendMode, float l, float t, float w, float h,  float x, float y, int verticesId, int uvsId, int indicesId, float *matrix, float alpha, int vertexNum, int p_nIBLen);
