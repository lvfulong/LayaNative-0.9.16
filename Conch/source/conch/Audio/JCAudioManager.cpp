...
void JCAudioManager::playMp3( const char* p_sUrl,int p_nTimes, int nCurrentTime,JCAudioInterface* p_pJSAudio )
{
	...
	m_pMp3Player->play( p_sUrl,p_nTimes, nCurrentTime,p_pJSAudio );
	if( m_bMuteMp3 )
	{
...
//------------------------------------------------------------------------------
OpenALSourceInfo* JCAudioManager::playWav(JCAudioInterface* p_pAudio, const std::string& p_sUrl)
{
    return m_pWavPlayer->playAudio(p_pAudio, p_sUrl);
}
...
//------------------------------------------------------------------------------
bool JCAudioManager::AddWaveInfo( const std::string& p_sUrl,JCBuffer& p_pBuffer,int p_nSize,void* p_pExternalMark,bool p_bIsOgg )
{
