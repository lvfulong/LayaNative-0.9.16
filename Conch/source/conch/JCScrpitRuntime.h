...
#ifndef __JCScrpitRuntime_H__
#define __JCScrpitRuntime_H__
...
namespace laya
{
    ...
    public:
         ...
         *  @return void
        */
        void init(JCFileResManager* pFileMgr, JCFileSource* pAssetRes, IConchThreadCmdMgr* pThreadCmdSender, JCFreeTypeFontRender* pFreeTypeRender, JCShapedTextCache* pShapedTextCache);
