...
public:
    ...
    int getMaxTextureMemSize();
    void setMaxTextureMemSize(int nSize);
    int getAtlasNum();
    void setAtlasNum(int nNum);
    int getPushAtlasLimitSize();
    void setPushAtlasLimitSize(int nSize);
    bool getLocalable();
...
public:
    ...
    //输出内存检测，log路径，如果为null，输出到cache目录下
    ...
    void setGraphicsTextBaseLine( int nType );
    ...
    */
    ...
    int getTextShapingMode() const;
    void setTextShapingMode(const char* strMode);
    void setTextCacheNum(int nNum);
    int getTextCacheNum();
public:
