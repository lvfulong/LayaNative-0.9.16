...
var ConchGraphics = (function () {
    function ConchGraphics() {
        this._cmds = null;
        this._direction = CanvasRenderingContext2D.DIRECTION['ltr'];
    ...
    ConchGraphics.prototype.drawImageM = function (img, sx, sy, sw, sh, dx, dy, dw, dh, mat, alpha, blendMode) {
    ...
    ConchGraphics.prototype.setDirection = function (font) {
    ...
    ConchGraphics.prototype.getDirection = function () {
        return CanvasRenderingContext2D.DIRECTION[this._direction];
    };
    ConchGraphics.prototype.drawPrimitive = function (texture, l, t, w, h, x, y, vertices, uvs, indices, mat, alpha, blendMode) {
        var vbSize = vertices.length;
        var uvSize = uvs.length;
        var ibSize = indices.length;
        if (vbSize <= 0 || uvSize <= 0 || ibSize <= 0 || vbSize != uvSize) {
            console.error("drawPrimitive warning");
            return;
        }
        var _ = conch.bf;
        if (vertices.conch_id === undefined || !vertices._upload) {
            vertices.conch_id = CanvasRenderingContext2D.ID++;
            vertices.conchRef = new ArrayBufferRef();
            vertices.conchRef.id = vertices.conch_id;
            _.needsz(16);
            _.wu32(0);
            _.wu32(11);
            _.wu32(vertices.conch_id);
            _.wu32(vertices.byteLength);
            _.wab(vertices, vertices.byteLength);
            vertices._upload = true;
        }
        if (uvs.conch_id === undefined || !uvs._upload) {
            uvs.conch_id = CanvasRenderingContext2D.ID++;
            uvs.conchRef = new ArrayBufferRef();
            uvs.conchRef.id = uvs.conch_id;
            _.needsz(16);
            _.wu32(0);
            _.wu32(11);
            _.wu32(uvs.conch_id);
        ...
        if (indices.conch_id === undefined || !indices._upload) {
            indices.conch_id = CanvasRenderingContext2D.ID++;
            indices.conchRef = new ArrayBufferRef();
            indices.conchRef.id = indices.conch_id;
            _.needsz(16);
            _.wu32(0);
            _.wu32(11);
            _.wu32(indices.conch_id);
            _.wu32(indices.byteLength);
            _.wab(indices, indices.byteLength);
            indices._upload = true;
        }
        _.needsz(88);
        _.wu32(this.id);
        _.wu32(30);
...
var CanvasRenderingContext2D = (function () {
    ...
    CanvasRenderingContext2D.DIRECTION = ["ltr", "rtl", "auto"];
...
_init(CanvasRenderingContext2D.DIRECTION);
