...
declare class context{
    ...
    appendBuffer(arrayBuffer:ArrayBuffer | ArrayBufferView,dataSize:number):void;
    setGetPixelsCallback(callBack:(data:ArrayBuffer, width:number, height:number)=>void):void;
    setToBase64Callback(callBack:(data:string)=>void):void;
}
...
interface conchConfig{
    ...
    */
	...
	/**
     * 设置自动模式
     * @parms thredholdms 鼠标不动thredholdms毫秒后降低为30帧
     */
	setMouseFrame(thredholdms:number);
...
declare class gl_mesh{
    
}

declare class ArrayBufferRef{
}


interface ConchTextCanvas{
    measureText(sText:string):TextMetrics;
    size(w:number,h:number);
    setFontInfo(font:string);
}
...
declare class conchNode2D{
    conchID:number;
    setRootNode():void;
    setFPSNode():void;
    setLoadingViewNode():void;
}

declare class _conchGraphics{
    conchID:number;
}
