/// <reference path="../../Conch/source/domsupport/ES6NoDOM.d.ts" />
/// <reference path="../../Conch/source/domsupport/LayaConchRuntime.d.ts" />
...
declare class ColorUtil {
    static getColorNum(str: string): number;
...
declare var createFadeID: () => number;
declare function ProgramLocationTable(): void;
declare class WebGLRenderingContext {
    ...
    getUniformLocation(program: any, name: any): any;
    getAttribLocation(program: any, name: any): any;
