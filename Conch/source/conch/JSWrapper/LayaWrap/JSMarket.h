...
public:
	enum{initjsid,loginid,logoutid,feedandshareid,inviteid,czid,buypropsid,authorizeid,refreshtokenid,
	getfriendsid,sendtodesktopid,topiccircleid,enterfeedbackid,enterbbsid,enterplatformid,
	switchuserid,enteraccountmgrid,setczinfoid,sendmessagetoplatformid,
