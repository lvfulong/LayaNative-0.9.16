...
public class LayaPlatformGlue
{
	...
	public String getMarketName()
	{
		...
		String sMarketName = LayaConch5.getMarketBundle().getString(LayaConch5.MARKET_MARKETNAME);
	...
	public String getServerName()
	{
		...
		String sServerName = LayaConch5.getMarketBundle().getString(LayaConch5.MARKET_SERVERNAME);
