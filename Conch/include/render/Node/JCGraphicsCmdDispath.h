...
namespace laya
{
    ...
    */
    ...
    public:
        ...
        void _rendercmd_direction(JCMemClass& cmdBuffer);
        void _rendercmd_drawPrimitive(JCMemClass& cmdBuffer);
        //------------------------------------------------------------------------------
        ...
        void _savecmd_direction(JCMemClass& cmdBuffer);
        void _savecmd_drawPrimitive(JCMemClass& cmdBuffer);
        //------------------------------------------------------------------------------
        ...
        void _calcBoundingBox_direction(JCMemClass& cmdBuffer, std::vector<Matrix32>& vMatrixs, Matrix32& kCurrentMatrix, std::vector<float>& vResultPointArray);
        void _calcBoundingBox_drawPrimitive(JCMemClass& cmdBuffer, std::vector<Matrix32>& vMatrixs, Matrix32& kCurrentMatrix, std::vector<float>& vResultPointArray);
    public:
