...
namespace laya {
    ...
    public:
        ...
        */
        ...
        JCRenderGroupData* pushPrimitive(float l, float t, float w, float h, int p_nVertType, const char* pVB, const char* pUV, const char* pIB, const Matrix32& pObjMatrix, JCMaterialBase* pMtl, float* pTexTrans, int vertNum, int p_nIBLen, bool flipV);
